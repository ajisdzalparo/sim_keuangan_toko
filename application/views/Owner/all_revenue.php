...
<section>
  <div class="container-fluid-sm p-3 mx-4">
    <div class="row-sm mt-4 mb-3">
      <h3 style="font-size: 20px;" class="col-sm "><span class="fw-bold">All</span> Revenue</h3>
    </div>
    <!-- Tombol Print -->
    <button onclick="printTable()" class="btn btn-primary">Print Semua Transaksi</button>
    <div class="row mt-5">
        ...
        <table class="table" id="revenueTable">
          ...
          <tbody class="bg-white">
            ...
            <?php else : ?>
              ...
              <?php foreach ($all_revenue as $row) : ?>
...
<script>
  function printTable() {
    var divToPrint = document.getElementById('revenueTable');
