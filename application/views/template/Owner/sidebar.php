...
<body>
 <div class="main-container">
  <div class="sidebar">
    ...
    <div class="main">
     ...
     <div class="list-item">
      <div>
       ...
       <!-- dropdown -->
       <div class="sub-menu">
        <a href="<?= base_url('owner/all_revenue') ?>" class="sub-item nav-link text-white font-10px">All</a>
        <a href="<?= base_url('owner/daily') ?>" class="sub-item nav-link text-white font-10px">Daily</a>
        <a href="<?= base_url('owner/monthly') ?>" class="sub-item nav-link text-white font-10px">Monthly</a>
        <a href="<?= base_url('owner/yearly') ?>" class="sub-item nav-link text-white font-10px">Yearly</a>
       </div>
      </div>
     </div>
     <div class="list-item">
      <a href="<?= base_url('owner/inventory') ?>">
   ...
   <a href="<?= base_url('owner/logout') ?>" class="logout">
