<?php if (empty($daily_data)) : ?>
    <div class="alert alert-primary mt-3" role="alert">
        <?= $this->session->flashdata('no_data'); ?>
    </div>
<?php endif ?>
...
<section>
    <div class="container-fluid-sm p-3 mx-4">
        <div class="row-sm mt-4 mb-3">
            <h3 style="font-size: 20px;" class="col-sm "><span class="fw-bold">Daily</span> Revenue</h3>
            <!-- Tombol Print -->
            <button onclick="printTable()" class="btn btn-primary">Print Transaksi Harian</button>
        </div>
        <div class="row mt-5">
...
<script>
    function printTable() {
        var divToPrint = document.getElementById('dailyTable');
